...
import { Users, Plus, Edit2, Trash2, Mail, MessageSquare, UserPlus } from "lucide-react"
...
export function FamilyManagement({ isOpen, onClose }: FamilyManagementProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-xl">
            ...
            Manage Family ({familyMembers.length}/8)
          </DialogTitle>
        </DialogHeader>
